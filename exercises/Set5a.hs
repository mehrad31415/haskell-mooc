...
setName name (Person a n) = Person a name

-- setAge does likewise for age
setAge :: Int -> Person -> Person
setAge age (Person a n) = Person age n
...
study x
  | x == Freshman  = NthYear 1
  | x == NthYear 1 = NthYear 2
  | x == NthYear 2 = NthYear 3
  | x == NthYear 3 = NthYear 4
  | x == NthYear 4 = NthYear 5
  | x == NthYear 5 = NthYear 6
  | x == NthYear 6 = NthYear 7
  | x == NthYear 7 = Graduated
  | x == Graduated = Graduated
------------------------------------------------------------------------------
...
rgb Blue  = [0,0,1]
rgb (Mix Red Green)  = [0.5,0.5,0]
rgb (Mix Green Red)  = [0.5,0.5,0]
rgb (Mix Red Blue)   = [0.5,0,0.5]
rgb (Mix Blue Red)   = [0.5,0,0.5]
rgb (Mix Blue Green) = [0,0.5,0.5]
rgb (Mix Green Blue) = [0,0.5,0.5]
...
fromList [] = Empty
fromList ((k,v):xs) = Pair k v y where y = fromList xs
...
toBin 1 = I End
toBin 0 = O End
toBin x =  toBin' (x `mod` 2) (toBin (x `div` 2))
